...
<section id="main" style="<?php if($image_attributes) echo 'background-image:url(\''.$image_attributes[0].'\')' ?>">
    <div class="row">
        <div class="columns align-self-middle text-center">
            ...
            <p class="text-center"><?php _e( 'Pellentesque sed sapien lorem at lacinia urna.', 'courseplanner' ); ?></p>
            <h2 class="text-center"><?php _e( 'Pellentesque Sed Sapien Lorem', 'courseplanner' ); ?></h2>
